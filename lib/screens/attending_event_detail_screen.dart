...
class AttendingEventDetailScreen extends StatelessWidget {
  // route name
  static const routeName = '/user-events-dashboard/attending-event-detail';

  // constructor
  const AttendingEventDetailScreen({Key? key}) : super(key: key);
    ...
    return StreamBuilder(
      ...
      builder: (ctx, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return const AttendingEventDetailScreenLoggedIn();
        } else {
...
class AttendingEventDetailScreenLoggedIn extends StatefulWidget {
  // constructor
  const AttendingEventDetailScreenLoggedIn({Key? key}) : super(key: key);

  @override
  State<AttendingEventDetailScreenLoggedIn> createState() =>
      _AttendingEventDetailScreenLoggedInState();
}

class _AttendingEventDetailScreenLoggedInState
    extends State<AttendingEventDetailScreenLoggedIn> {
  // variables
  ...
  Widget _buildActionButton(Event event) {
    ...
    if (eventDate.isAfter(now)) {
      ...
      return const ElevatedButton(
        onPressed: null,
        child: Text('Attended/Not Attended'),
      );
    }
  }
