...
class AttendingEventDetailScreen extends StatefulWidget {
  // route name
  ...
  @override
  State<AttendingEventDetailScreen> createState() =>
      _AttendingEventDetailScreenState();
}

class _AttendingEventDetailScreenState
    extends State<AttendingEventDetailScreen> {
  // variables
